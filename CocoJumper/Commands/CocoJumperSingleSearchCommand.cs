...
namespace CocoJumper.Commands
{
    internal sealed class CocoJumperSingleSearchCommand
    {
        ...
        private CocoJumperSingleSearchCommand(AsyncPackage _package, OleMenuCommandService _commandService, IVsTextManager _textManager, IVsEditorAdaptersFactoryService _editorAdaptersFactoryService)
        {
